...
const {createPurchaseVoucher,updatePurchaseVoucher,reversePurchaseVoucher,getPurchaseItems,getPurchaseItemsByVoucherNo} = require("../controllers/voucherPurchase.controller");
...
router.get("/purchase/by-voucher/:voucherNo/items",auth,getPurchaseItemsByVoucherNo);
